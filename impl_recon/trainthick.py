...
# Assuming `checkpoint_writer` and `model_dir` are already initialized
def main():
    params, config_filepath = config_io.parse_config_train()
    # model_basedir: Path = r"/public/home/chenhb/cheryl/implicit-shape-reconstruction/models_nw"
    model_dir = Path(r'/public/home/chenhb/cheryl/implicit-shape-reconstruction/models_dir/Thick')
    task_type = params['task_type']
    ...
    # latest_checkpoint = checkpoint_writer.get_latest_checkpoint()
